...
void NVIC_init(void)
{
    ...
    NVIC_REG.EN0.B19	=	TIMER0A_NVIC;
    NVIC_REG.EN0.B20	=	TIMER0B_NVIC;
    NVIC_REG.EN0.B21	=	TIMER1A_NVIC;
    NVIC_REG.EN0.B22	=	TIMER1B_NVIC;
    NVIC_REG.EN0.B23	=	TIMER2A_NVIC;
    NVIC_REG.EN0.B24	=	TIMER2B_NVIC;
