...
#define TIMER0_REG_BASE 	((volatile TimerRegs_t *)0x40030000)
#define TIMER1_REG_BASE		((volatile TimerRegs_t *)0x40031000)
#define TIMER2_REG_BASE		((volatile TimerRegs_t *)0x40032000)
#define TIMER3_REG_BASE		((volatile TimerRegs_t *)0x40033000)
#define TIMER4_REG_BASE		((volatile TimerRegs_t *)0x40034000)
#define TIMER5_REG_BASE		((volatile TimerRegs_t *)0x40035000)	
...
#define RCGCWD_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x600)))
#define RCGCTIMER_REG		(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x604)))
#define RCGCGPIO_REG    (*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x608)))
#define RCGCDMA_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x60C)))
#define RCGCHIB_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x614)))
#define RCGCUART_REG    (*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x618)))
#define RCGCSSI_REG     (*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x61C)))
#define RCGCI2C_REG     (*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x620)))
#define RCGCUSB_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x628)))	
#define RCGCCAN_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x634)))
#define RCGCADC_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x638)))
#define RCGCACMP_REG		(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x63C)))
#define RCGCPWM_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x640)))
#define RCGCQEI_REG			(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x644)))
#define	RCGCEEPROM_REG	(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x658)))
#define RCGCWTIMER_REG	(*((volatile RCGC_TagType*)(SYSCTRL_BASE_ADDRESS + 0x65C)))
